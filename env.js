 ...
 * we use dotenv to load the correct variables from the .env file
 */
 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.catapp.staging
 */

const BUNDLE_ID = 'com.catapp'; // ios bundle id
const PACKAGE = 'com.catapp'; // android package name
const NAME = 'CatApp'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = '20c7d35a-e305-4c1b-a590-223132sc3dsc'; // eas project id
const SCHEME = 'CatApp'; // app scheme
...
const client = z.object({
  ...
  // CLIENT ENV VARS GOES HERE
  API_URL: z.string(),
});

const buildTime = z.object({
  // Add any non-EXPO_PUBLIC variables here if needed
...
export { ClientEnv, Env, withEnvSuffix };
